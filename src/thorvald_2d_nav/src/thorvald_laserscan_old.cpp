...
int minPoints =0;
int first_range = 0, second_range = 0;
float array[360][2];
int k = 0, q = 0;
double biggest_x, biggest_y, Current_x_1, Current_y_1, Current_x_2, Current_y_2, final_range_1, final_range_2;
double range_1[360], range_2, count_angle_1[360];
ros::Publisher x_dist;
...
/*          double smallest = range_1[0];
          for (int p=1; p < sizeof(range_1)/sizeof(range_1[0]); ++p){
            if (range_1[p] < smallest ){
               smallest_range = range_1[p] ;
               smallest_iteration = count_angle_1[p];
               count_1 = 1;
            }
          }  
           // std::cout << "smallest_range" << smallest_range << "/n" << "smallest_iteration" << smallest_iteration << std::endl;

           if(count_1 == 1){
           Current_x_1 = x[smallest_iteration];
           Current_y_1 = y[smallest_iteration];
           }
*/
//---------------------- SECOND HALF ---------------------------//
...
//---------------------- FIRST HALF ---------------------------//
		...
		sum_y_1+=array[j][2];
         ...
         // final_x_1 = sum_x_1;
         // final_y_1 = sum_y_1;
         // final_range_1 = range_1;
         // }

        // if(range_1 < final_range_1 && (count_1 == 1)){
         final_x_1 = sum_x_1;
         final_y_1 = sum_y_1;
         // final_range_1 = range_1;
         // count_1 = 2;
...
//---------------------- SECOND HALF ---------------------------//
		...
		sum_y_2+=array[j][2];
         ...
         final_x_2 = sum_x_2;
         final_y_2 = sum_y_2;
         final_range_2 = range_2;
         }

         if(range_2 < final_range_2 && (count_2 == 1)){
         final_x_2 = sum_x_2;
         final_y_2 = sum_y_2;
         final_range_2 = range_2;
