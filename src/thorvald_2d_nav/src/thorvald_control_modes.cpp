...
double control_law(double v){
  ...
  angular_error = (mini_goal_pts.y-thorvald_estimated_pose.pose.pose.position.y/mini_goal_pts.x-thorvald_estimated_pose.pose.pose.position.x) - yaw;
